      ...
      <section className={styles.habilidades} id='habilidades'>
        ...
        <div className={styles.habilidades_container}>
          ...
          <div className={styles.skillCardsArea} >
            <Card arrObjs={[js, ts]} cardText={textJSTS} cardTitle='Javscript & Typescript' />
            <Card arrObjs={[react, next]} cardText={textReactNext} cardTitle='React JS & Next' />
            <Card arrObjs={[node]} cardText={jsText} cardTitle='Node JS' />
            <Card arrObjs={[html, css, sass]} cardText={jsText} cardTitle='HTML, CSS & SASS' />
            <Card arrObjs={[gitBash, gitHub]} cardText={jsText} cardTitle='GIT & Github' />
            <Card arrObjs={[figma, adobeXd, corel, illustrato]} cardText={jsText} cardTitle='Web Design Tools' />
          </div>
        </div>
